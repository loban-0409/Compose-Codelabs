        ...
        setContent {
            BasicsTheme {
                ...
                Surface(
                    ...
                    Tutorial(title = title, firstContent = firstContent, secondContent = secondContent, image = image)
                }
            }
        }
    }
...
@Composable
fun Tutorial(title: String, firstContent: String, secondContent: String, image: Painter, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
    ) {
